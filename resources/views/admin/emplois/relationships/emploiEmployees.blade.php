...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-emploiEmployees">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.employee.fields.matricule') }}
                        </th>
                        <th>
                            {{ trans('cruds.employee.fields.nni') }}
                        </th>
                        <th>
                        ...
                        <th>
                            {{ trans('cruds.employee.fields.recruitement_date') }}
                        </th>
                        <th>
                            {{ trans('cruds.employee.fields.emploi') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
                ...
                <tbody>
                    @foreach($employees as $key => $employee)
                        <tr data-entry-id="{{ $employee->id }}">
                            ...
                            <td>
                                {{ $employee->recruitement_date ?? '' }}
                            </td>
                            <td>
                                {{ $employee->emploi->name ?? '' }}
                            </td>
                            <td>
                                @can('employee_show')
...
@endcan
  ...
  let table = $('.datatable-emploiEmployees:not(.ajaxTable)').DataTable({ buttons: dtButtons })
