    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.articles.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('autorised_quantity') ? 'is-invalid' : '' }}" type="number" name="autorised_quantity" id="autorised_quantity" value="{{ old('autorised_quantity', '0') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('prix_aquisition') ? 'is-invalid' : '' }}" type="number" name="prix_aquisition" id="prix_aquisition" value="{{ old('prix_aquisition', '0') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('prix') ? 'is-invalid' : '' }}" type="number" name="prix" id="prix" value="{{ old('prix', '0') }}" step="1">
                @if($errors->has('prix'))
                    <div class="invalid-feedback">
                        {{ $errors->first('prix') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('seuil') ? 'is-invalid' : '' }}" type="number" name="seuil" id="seuil" value="{{ old('seuil', '0') }}" step="1">
                @if($errors->has('seuil'))
                    <div class="invalid-feedback">
                        {{ $errors->first('seuil') }}
                    </div>
