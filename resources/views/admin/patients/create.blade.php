    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.patients.store") }}" enctype="multipart/form-data">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <div class="form-inline">
                                    <select class="col-sm-2 {{ $errors->has('genre') ? 'is-invalid' : '' }}" name="genre_id" id="genre_id" required>
                                        ...
                                        <option value="{{ $id }}" {{ old('genre_id') == $id ? 'selected' : '' }}>{{ $genre }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control date {{ $errors->has('birth_day') ? 'is-invalid' : '' }}" type="text" name="birth_day" id="birth_day" value="{{ old('birth_day') }}" required>
                            ...
                            <div class="form-group">
                                <input type="checkbox" id='albinos' name='albinos' style="margin-right: 10px;">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('poids') ? 'is-invalid' : '' }}" type="number" name="poids" id="poids" value="{{ old('poids', '0') }}" step="1">
                @if($errors->has('poids'))
                <div class="invalid-feedback">
                    {{ $errors->first('poids') }}
                </div>
