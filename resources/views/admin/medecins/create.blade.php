        ...
        <div class="card col-md-6">
            ...
            <div class="card-body">
                <div class="form-group form-inline">
                    <label class="col-sm-2 required " for="grade_id">{{ trans('cruds.medecin.fields.grade') }}</label>
                    <select class="col-sm-10 form-control {{ $errors->has('grade') ? 'is-invalid' : '' }}" name="grade_id" id="grade_id" required>
                        @foreach($grades as $id => $grade)
                        <option value="{{ $id }}" {{ old('grade_id') == $id ? 'selected' : '' }}>{{ $grade }}</option>
                        @endforeach
                    </select>
                    @if($errors->has('grade'))
                ...
                <div class="form-group form-inline">
                    <label class="col-sm-2 required" for="specialite_id">{{ trans('cruds.medecin.fields.specialite') }}</label>
                    <select class="form-control col-sm-10 {{ $errors->has('specialite') ? 'is-invalid' : '' }}" name="specialite_id" id="specialite_id" required>
                        @foreach($specialites as $id => $specialite)
                        <option value="{{ $id }}" {{ old('specialite_id') == $id ? 'selected' : '' }}>{{ $specialite }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group form-inline">
                    <label class="col-sm-2 required" for="name">{{ trans('cruds.medecin.fields.name') }}</label>
                    <input class="col-sm-10 form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', '') }}" required>
                    @if($errors->has('name'))
                    <div class="invalid-feedback">
                        {{ $errors->first('name') }}
                    </div>
                    ...
                    <div class="card col-md-6">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control {{ $errors->has('phone_2') ? 'is-invalid' : '' }}" type="number" name="phone_2" id="phone_2" value="{{ old('phone_2', '') }}" step="1">
                    ...
                    <div class="card col-md-6">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input class="form-control {{ $errors->has('free_days') ? 'is-invalid' : '' }}" type="number" name="free_days" id="free_days" value="{{ old('free_days', '7') }}" step="1" required>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control {{ $errors->has('daily_consultation') ? 'is-invalid' : '' }}" type="number" name="daily_consultation" id="daily_consultation" value="{{ old('daily_consultation', '0') }}" step="1">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control {{ $errors->has('daily_rdv') ? 'is-invalid' : '' }}" type="number" name="daily_rdv" id="daily_rdv" value="{{ old('daily_rdv', '0') }}" step="1">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control {{ $errors->has('consultation_duration') ? 'is-invalid' : '' }}" type="number" name="consultation_duration" id="consultation_duration" value="{{ old('consultation_duration', '0') }}" step="1">
