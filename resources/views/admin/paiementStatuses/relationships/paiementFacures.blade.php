...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-paiementFactures">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.facture.fields.paiement') }}
                        </th>
                        <th>
...
@endcan
  ...
  let table = $('.datatable-paiementFactures:not(.ajaxTable)').DataTable({ buttons: dtButtons })
