...
<div class="card">
    <div class="card-header">
        {{ trans('cruds.soin.title_singular') }} {{ trans('global.list') }}
    </div>

    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-caisseSoins">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.soin.fields.name') }}
                        </th>
                        <th>
                            {{ trans('cruds.soin.fields.prix') }}
                        </th>
                        <th>
                            {{ trans('cruds.soin.fields.caisse') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
...
@can('soin_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.soins.massDestroy') }}",
...
@endcan
  ...
  let table = $('.datatable-caisseSoins:not(.ajaxTable)').DataTable({ buttons: dtButtons })
